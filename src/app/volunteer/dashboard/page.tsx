...
const dashboardItems = [
  ...
  { icon: Ticket, label: "Token Generation", number: 10, href: "/volunteer/dashboard" },
  { icon: Hourglass, label: "Patients Waiting", number: 11, href: "/volunteer/dashboard" },
  { icon: HelpingHand, label: "Doctor Assistance", number: 12, href: "/volunteer/dashboard" },
  { icon: List, label: "View Queues", number: 13, href: "/volunteer/view-queues" },
  { icon: Truck, label: "Medicine Delivery", number: 14, href: "/volunteer/dashboard" },
  { icon: Utensils, label: "Food", number: 15, href: "/volunteer/dashboard" },
